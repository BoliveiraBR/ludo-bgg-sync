...
const verificarJogosOmitidos = require('./VerificarJogosOmitidos');
...
console.log(`Complementando comparacão com GPT-4`);
...
console.log('📄 Resultado atualizado em CollectionComparison.txt');

verificarJogosOmitidos(bggFromFile, ludoFromFile, allMatches);
}
